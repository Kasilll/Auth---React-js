      ...
      <div className="auth">
        <form className="auth__form" onSubmit={handleSubmit}>
          ...
          <TextField
            ...
            variant="outlined"
          />
          {userNameErorr && userNameDirty && <div style={{ color: 'red', fontSize: '12px' }}>{userNameErorr}</div>}
          <TextField
            type="password"
            className="outlined-basic"
          ...
          />
          {passwordErorr && passwordDirty && <div style={{ color: 'red', fontSize: '12px' }}>{passwordErorr}</div>}

          {/* formValid из названия значит, что форма валидна, но в использовании оказывается, что наоборот  */}
